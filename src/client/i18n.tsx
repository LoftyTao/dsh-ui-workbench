...
const en = {
  ...
  renderingTypst: 'Rendering Typst…',
  typstPreviewFailed: 'Typst preview failed',
  typstNotInstalled: 'Install the Typst CLI on the Harness host, or set DSH_TYPST_BIN to its executable path.',
...
const zh: Record<MessageKey, string> = {
  ...
  renderingTypst: '正在渲染 Typst…',
  typstPreviewFailed: 'Typst 预览失败',
  typstNotInstalled: '请在 Harness Host 安装 Typst CLI，或通过 DSH_TYPST_BIN 指定可执行文件路径。',
  previewPage: '预览页码',
  previousPage: '上一页',
  nextPage: '下一页',
  // Review toolbar
